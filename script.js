const questionBank = [
  ...
  { question: "Which African country is an island nation in the Indian Ocean?", answers: ["Comoros", "Madagascar", "Mauritius", "All of these"], correct: 3 },
  ...
  { question: "What is the chemical symbol for iron?", answers: ["Ir", "In", "Fe", "Fr"], correct: 2 },
  ...
  { question: "What is the hardest bone in the human body?", answers: ["Femur", "Skull", "Jawbone", "Spine"], correct: 2 },
  ...
  { question: "In which city was the Magna Carta signed?", answers: ["London", "Oxford", "Runnymede", "Canterbury"], correct: 2 },
  ...
  { question: "Which instrument does a pianist play?", answers: ["Guitar", "Violin", "Piano", "Drums"], correct: 2 },
  ...
  { question: "What is the name of the longest wall in the world?", answers: ["Hadrian's Wall", "Great Wall of China", "Berlin Wall", "Aurelian Wall"], correct: 1 },
  ...
  { question: "Which country has the most UNESCO World Heritage Sites?", answers: ["France", "China", "Italy", "Spain"], correct: 2 },
  ...
  { question: "Which country has the most official languages?", answers: ["India", "South Africa", "Switzerland", "Bolivia"], correct: 1 },
  { question: "What is the most visited tourist attraction in the world?", answers: ["Eiffel Tower", "Great Wall of China", "The Louvre", "Times Square"], correct: 2 },
  { question: "Who wrote the novel 1984?", answers: ["Aldous Huxley", "George Orwell", "Ray Bradbury", "H.G. Wells"], correct: 1 },
  { question: "Which country has the most billionaires?", answers: ["China", "USA", "India", "Germany"], correct: 1 },
  ...
  { question: "Which African country has the most pyramids?", answers: ["Egypt", "Sudan", "Ethiopia", "Libya"], correct: 1 },
  ...
  { question: "Which is the only African country with coastlines on both the Atlantic and Indian Oceans?", answers: ["Angola", "Tanzania", "Mozambique", "South Africa"], correct: 3 },
  ...
  { question: "Which African country has the most national parks?", answers: ["Kenya", "Tanzania", "South Africa", "Zambia"], correct: 2 },
  { question: "What is the capital of Burkina Faso?", answers: ["Bobo-Dioulasso", "Ouagadougou", "Koudougou", "Banfora"], correct: 1 },
  { question: "Which body of water separates Africa from Europe?", answers: ["Red Sea", "Suez Canal", "Mediterranean Sea", "Strait of Gibraltar"], correct: 3 },
  ...
  { question: "Which African country has the most mobile phone users?", answers: ["South Africa", "Egypt", "Nigeria", "Kenya"], correct: 2 },
